  ...
  en: {
    ...
    tutorial_steps: [
      ...
      { icon: '<img src="/assets/Badge/Coffee_Badge.png" style="width:52px;height:52px;object-fit:contain" alt="☕">', title: 'XP Bar & Beans',
        body: 'Study 3 days to fill the XP bar. Once full, each study day earns a <img src="/assets/Token/Token_Coffee.png" style="width:16px;height:16px;vertical-align:middle" alt=""> bean.<br><br>Collect beans to <strong>auto-unlock cosmetics</strong> — profile frames, themes, and calendar badges — in Settings → Appearances.' },
  ...
  fr: {
    ...
    tutorial_steps: [
      ...
      { icon: '<img src="/assets/Badge/Coffee_Badge.png" style="width:52px;height:52px;object-fit:contain" alt="☕">', title: 'Barre XP & Grains',
        body: 'Étudie 3 jours pour remplir la barre XP. Une fois pleine, chaque jour d\'étude rapporte un grain <img src="/assets/Token/Token_Coffee.png" style="width:16px;height:16px;vertical-align:middle" alt="">.<br><br>Accumule des grains pour <strong>débloquer automatiquement des cosmétiques</strong> — cadres, thèmes et badges — dans Paramètres → Apparences.' },
  ...
  es: {
    ...
    tutorial_steps: [
      ...
      { icon: '<img src="/assets/Badge/Coffee_Badge.png" style="width:52px;height:52px;object-fit:contain" alt="☕">', title: 'Barra XP & Granos',
        body: 'Estudia 3 días para llenar la barra XP. Una vez llena, cada día da un grano <img src="/assets/Token/Token_Coffee.png" style="width:16px;height:16px;vertical-align:middle" alt="">.<br><br>Acumula granos para <strong>desbloquear cosméticos automáticamente</strong> — marcos, temas y badges — en Ajustes → Apariencias.' },
  ...
  de: {
    ...
    tutorial_steps: [
      ...
      { icon: '<img src="/assets/Badge/Coffee_Badge.png" style="width:52px;height:52px;object-fit:contain" alt="☕">', title: 'XP-Leiste & Bohnen',
        body: 'Lerne 3 Tage, um die XP-Leiste zu füllen. Danach bringt jeder Lerntag eine <img src="/assets/Token/Token_Coffee.png" style="width:16px;height:16px;vertical-align:middle" alt=""> Bohne.<br><br>Sammle Bohnen, um <strong>Kosmetika automatisch freizuschalten</strong> — Rahmen, Themes und Abzeichen — in Einstellungen → Erscheinungsbild.' },
  ...
  ru: {
    ...
    tutorial_steps: [
      ...
      { icon: '<img src="/assets/Badge/Coffee_Badge.png" style="width:52px;height:52px;object-fit:contain" alt="☕">', title: 'Шкала XP & Зёрна',
        body: 'Занимайся 3 дня, чтобы заполнить шкалу XP. После заполнения каждый день приносит <img src="/assets/Token/Token_Coffee.png" style="width:16px;height:16px;vertical-align:middle" alt=""> зёрнышко.<br><br>Накапливай зёрна для <strong>автоматической разблокировки косметики</strong> — рамки, темы и значки — в Настройки → Внешний вид.' },
