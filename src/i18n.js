...
const TRANSLATIONS = {
  ...
  fr: {
    ...
    tab_hints: {
      ...
      stats:  { title: 'Stats — Ta Progression',                   body: `<p>Graphiques et historique de ton parcours d'étude.</p><ul><li><b>Barre XP</b> — remplis 3 segments en étudiant 3 jours. Une fois pleine, chaque jour d'étude rapporte un grain 🫘. Dépense tes grains dans la Boutique (⚙️ Paramètres).</li><li><b>Tuile série</b> — appuie pour basculer entre série actuelle et jours totaux ce mois.</li><li><b>Activité d'étude</b> — mots par jour. Bascule 1S / 2S / calendrier mensuel.</li><li><b>Progression JLPT</b> — combien il te reste pour atteindre ton objectif.</li><li><b>Défi hebdomadaire</b> — ton dernier résultat du Défi hebdomadaire si complété.</li></ul>` },
  ...
  es: {
    ...
    // ── Pistas de pestañas (ⓘ) ───────────────────────────────────────
    tab_hints: {
      home:   { title: 'Inicio — Tu Panel',                       body: `<p>Tu centro de estudio diario. Todo de un vistazo.</p><ul><li><b>Racha</b> — días consecutivos de estudio. ¡No rompas la cadena! Toca para alternar entre días de racha y el recuento de este mes.</li><li><b>Quiz diario</b> — practica las palabras que has guardado. Vuelve cada día para nuevo vocabulario.</li><li><b>Desafío semanal</b> — cada lunes, un quiz sobre las 2 últimas semanas.</li><li><b>Tarjeta JLPT</b> — registra palabras guardadas hacia tu objetivo. Toca para cambiar nivel.</li><li><b>☕ Barra XP</b> — estudia 3 días para llenar la barra. Una vez llena, cada día de estudio da un grano 🫘. Un día perdido resta 1/3. Gasta tus granos en la Tienda (menú ⚙️ Ajustes).</li></ul>` },
      ...
      stats:  { title: 'Stats — Tu Progreso',                      body: `<p>Gráficas e historial de tu aprendizaje.</p><ul><li><b>Barra XP</b> — rellena 3 segmentos estudiando 3 días. Una vez llena, cada día de estudio da un grano 🫘. Gasta tus granos en la Tienda (⚙️ Ajustes).</li><li><b>Tarjeta de racha</b> — toca para alternar entre racha actual y días totales este mes.</li><li><b>Actividad de estudio</b> — palabras por día. Alterna 1S / 2S / calendario mensual.</li><li><b>Progreso JLPT</b> — qué tan cerca estás del vocabulario de tu nivel objetivo.</li><li><b>Desafío semanal</b> — tu último resultado del Desafío semanal si completado.</li></ul>` },
  ...
  de: {
    ...
    tab_hints: {
      ...
      stats:  { title: 'Stats — Dein Fortschritt',                   body: `<p>Diagramme und Verlauf deines Lernwegs.</p><ul><li><b>XP-Leiste</b> — fülle 3 Segmente durch 3 Lerntage. Danach bringt jeder Lerntag eine 🫘 Bohne. Bohnen im Shop ausgeben (⚙️ Einstellungen).</li><li><b>Serien-Kachel</b> — tippen zum Wechseln zwischen Serienanzahl und Monatstagen.</li><li><b>Lernaktivität</b> — Wörter pro Tag. Wechsel 1W / 2W / Monatskalender.</li><li><b>JLPT-Fortschritt</b> — wie nah du dem Vokabular deines Ziellevels bist.</li><li><b>Wochenchallenge</b> — dein letztes Ergebnis der Wochenchallenge.</li></ul>` },
