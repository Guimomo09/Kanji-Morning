...
const TRANSLATIONS = {
  ...
  en: {
    ...
    tutorial_steps: [
      ...
      { icon: '試', title: 'Quiz & Exam',
        body: '<strong>Daily Quiz</strong> — test yourself on today\'s saved words.<br><br><strong>Smart Review (SRS)</strong> — the app schedules words you struggle with for the perfect revision time.<br><br><strong>Exam Mode</strong> — 20 questions · 7 min · 60% to pass. A real JLPT simulation.' },
  ...
  fr: {
    ...
    tutorial_steps: [
      ...
      { icon: '試', title: 'Quiz & Examen',
        body: '<strong>Quiz quotidien</strong> — teste-toi sur les mots du jour.<br><br><strong>Révision intelligente (SRS)</strong> — l\'app reprogramme les mots difficiles au moment parfait.<br><br><strong>Mode Examen</strong> — 20 questions · 7 min · 60 % pour réussir. Simulation JLPT réelle.' },
  ...
  es: {
    ...
    tutorial_steps: [
      ...
      { icon: '試', title: 'Quiz & Examen',
        body: '<strong>Quiz diario</strong> — ponte a prueba con las palabras de hoy.<br><br><strong>Repaso inteligente (SRS)</strong> — la app reprograma las palabras difíciles al momento perfecto.<br><br><strong>Modo Examen</strong> — 20 preguntas · 7 min · 60 % para pasar. Simulación JLPT real.' },
  ...
  de: {
    ...
    tutorial_steps: [
      ...
      { icon: '試', title: 'Quiz & Prüfung',
        body: '<strong>Tages-Quiz</strong> — teste dich täglich mit heutigen Wörtern.<br><br><strong>Smartes Wiederholen (SRS)</strong> — die App plant Wiederholungen zum perfekten Zeitpunkt.<br><br><strong>Prüfungsmodus</strong> — 20 Fragen · 7 Min. · 60 % zum Bestehen. Echte JLPT-Simulation.' },
  ...
  ru: {
    ...
    tutorial_steps: [
      ...
      { icon: '試', title: 'Тест & Экзамен',
        body: '<strong>Дневной тест</strong> — проверяй себя по сохранённым словам.<br><br><strong>Умное повторение (SRS)</strong> — приложение планирует сложные слова на идеальный момент.<br><br><strong>Режим Экзамена</strong> — 20 вопросов · 7 мин · 60 % для сдачи. Настоящая симуляция JLPT.' },
